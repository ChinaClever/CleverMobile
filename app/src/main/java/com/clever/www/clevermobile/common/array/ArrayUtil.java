package com.clever.www.clevermobile.common.array;
...
/**
 * Author: lzy. Created on: 16-11-10.
 * 有时候需要把String换成byte操作的场景,那么就会涉及到一些针对byte数组的操作需要，如在一个数组中查找一个小数组、数组替换、数组扩展等操作，
 */
public class ArrayUtil {
    ...
    /********************************************************************/
    /**
     * String换成byte操作的场景,那么就会涉及到一些针对byte数组的操作需要，
     * 如在一个数组中查找一个小数组、数组替换、数组扩展等操作，
     * 下面这个类就提供了这样一组方法
     */
